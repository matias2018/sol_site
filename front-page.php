...
<main id="main">
  ...
  <section id="welcome" class="about">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-xl-6 col-lg-6 video-box d-flex justify-content-center align-items-stretch" style="position: relative;" data-aos="fade-right">
          <a aria-expanded="false" href="#" class="venobox play-btn mb-4 wp-video-popup" data-vbtype="video" data-autoplay="true" style="position: relative; left: 0; top: -100px; margin: auto; z-index: 1;">
            ...
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              ...
              <div class="member-info">
                ...
                <div class="social fp-social">
                  ...
                  if ($linkedin_url) : ?>
                    <a class="with-tooltip" target="_blank" href="<?= $linkedin_url; ?>">
                  ...
                  if ($researchgate_url) : ?>
                    <a class="with-tooltip" target="_blank" href="<?= $researchgate_url; ?>">
  ...
  <section id="getHere" class="transportes">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4" data-aos="fade-right" data-aos-delay="100">
          <p>
            <a href="https://www.metrolisboa.pt/viajar/alameda-linha-verde/" target="_blank" alt="Link para site externo (abre numa nova janela)">Metro - Estação Alameda (linhas Verde e Vermelha)
              <i class="bi bi-box-arrow-up-right"></i>
            </a>
          </p>

          <p>
            <a href="https://www.carris.pt/viaje/planear-viagem/" target="_blank" alt="Link para site externo (abre numa nova janela)">Carris - Planeie a sua viagem
              <i class="bi bi-box-arrow-up-right"></i>
            </a>
          </p>

          <p>
            <a href="https://www.gira-bicicletasdelisboa.pt/descobre-as-estacoes/" target="_blank" alt="Link para site externo (abre numa nova janela)">Estação GIRA 421 – Bicicletas de Lisboa
              <i class="bi bi-box-arrow-up-right"></i>
            </a>
          </p>

          <p>
            <a href="https://www.empark.com/pt/pt/aparcamento/lisboa/alameda/" target="_blank" alt="Link para site externo (abre numa nova janela)">Parque de estacionamento subterrâneo 24h
              <i class="bi bi-box-arrow-up-right"></i>
            </a>
          </p>
          <hr>
          ...
          <div class="address">
            <a class="only_desktop" href="http://maps.apple.com/maps?q=38.7381544501084,-9.133893630764298,19.84z/data=!4m5!3m4!1s0xd1933bcc894229b:0x71b995c2eca07f49!8m2!3d38.7382344!4d-9.1339702" target="_blank" alt="Link para site externo (abre numa nova janela)">
              <span class="sr-only">abrir mapa</span>
              <i class="bi bi-geo-alt only_desktop"></i>
            </a>
            <a class="only_mobile" href="geo:38.7381544501084,-9.133893630764298;u=35" target="_blank" alt="Link para site externo (abre numa nova janela)">
              <span class="sr-only">abrir mapa</span>
              <i class="bi bi-geo-alt only_mobile"></i>
            </a>
            <h4>Morada:</h4>
        ...
        <div id="modalBody" class="modal-body">
          ...
          <div class="form-choices">
            <ul class="dropdown-list settings-menu">
              ...
              <li class="dropdown-list-item settings-menu-item">
                <div class="form-check form-switch">
                  <input class="form-check-input useHighContrast" type="checkbox" role="switch" id="flexSwitchCheckChecked">
                  <label onclick="myFunction_get()" class="form-check-label" for="flexSwitchCheckChecked">Alto Contraste
                  </label>
                </div>
              </li>
              ...
              <li class="dropdown-list-item settings-menu-item">
                <div class="form-check form-switch">
                  <input class="form-check-input useAnimation" type="checkbox" role="switch" id="AnimationToggle" checked>
                  <label onclick="aosOff_get()" class="form-check-label" for="AnimationToggle">Animações
                  </label>
                </div>
              </li>
            </ul>
